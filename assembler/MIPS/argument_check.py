...
from assembler.errors import InvalidArgument, NotEvenRegister
...
def check_even_register(register, line_num):
    if int(register.get_nm()[1:]) % 2 != 0:
        raise NotEvenRegister(register.__str__()[1:], line_num)
