...
function avg_hex(flavor) {
	code_string = '';
	if (flavor == 'intel'){
		code_string += '; Declare an array and declare size of the array\n.data\n    nbrArray DW 0x19, 0x2F, -0xF, -0x0x20, 32, 0x5F DUP (0xA)\n    nbrElts DW 0x64\n\n; Calculate the average of the array:\n.text\n    mov eax, 0x0\n    mov ebx, 0x0\n    mov edx, 0x0\n    mov ecx, [nbrElts]\nforCount0x1: cmp ebx, ecx\n           je endCount\nbody: add eax, [ebx]\n      inc ebx\n      jmp forCount0x1\nendCount: idiv ecx \n\n\n';
	}
	else if (flavor == 'att'){
		code_string += '; Declare an array and declare size of the array\n.data\n    nbrArray: .short 0x19, 0x2F, -0xF, -0x0x20, 32, 0x5F DUP (0xA)\n    nbrElts: .short 0x64\n\n; Calculate the average of the array:\n.text\n    mov $0x0, %eax\n    mov $0x0, %ebx\n    mov $0x0, %edx\n    mov (nbrElts), %ecx\nforCount0x1: cmp %ebx, %ecx\n           je endCount\nbody: add (%ebx), %eax\n      inc %ebx\n      jmp forCount0x1\nendCount: idiv %ecx \n\n\n';
	}
	else if (flavor == 'mips_asm'){
