...
#####################
    ...
    def two_op_test(self, operator, instr,
        ...
        for i in range(0, NUM_TESTS):
            ...
            assemble(instr + " %ebx, %eax", 'att', vmachine)
...
###################
    ...
    def one_op_test(self, operator, instr):
        for i in range(NUM_TESTS):
            ...
            correct = operator(a)
            vmachine.registers["EAX"] = a
            assemble(instr + " %eax", 'att', vmachine)
            self.assertEqual(vmachine.registers["EAX"], correct)
...
##################
    ...
    def test_push_and_pop(self):
        ...
        for i in range(STACK_TOP, STACK_BOTTOM-1, -1): # Traverse the stack registers.
            ...
            correct_stack[i] = a
            vmachine.registers["EAX"] = a
            assemble("push %eax", 'att', vmachine)

        for i in range(STACK_BOTTOM, STACK_TOP+1):
            assemble("pop %ebx", 'att', vmachine)
...
##################
    ...
    def test_idiv(self):
        for i in range(0, NUM_TESTS):
            ...
            vmachine.registers["EBX"] = b
            assemble("idiv %ebx", 'att', vmachine)
    ...
    def test_cmp_eq(self):
        ...
        vmachine.flags["ZF"] = 0
        vmachine.flags["SF"] = 0
        assemble("cmp %ebx, %eax", 'att', vmachine)
