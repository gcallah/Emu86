...
class TestPrograms(TestCase):
    ...
    def test_loop(self):
        self.run_test_code("tests/Intel/loop.asm")
        self.assertEqual(vmachine.registers["ECX"], 16)

    def test_power(self):
        self.run_test_code("tests/Intel/power.asm")
        self.assertEqual(vmachine.registers["EDX"], 65536)

    def test_gt(self):
        self.run_test_code("tests/Intel/gt.asm")
    ...
    def test_interrupt(self):
        self.run_test_code("tests/Intel/test_interrupt.asm")
    ...
    def test_key(self):
        self.run_test_code("tests/Intel/key_test.asm")
        self.assertEqual(vmachine.registers["EAX"], 71)
    ...
    def test_arithmetic_shift(self):
        self.run_test_code("tests/Intel/arithmetic_shift.asm")
    ...
    def test_array_avg(self):
        self.run_test_code("tests/Intel/array_average_test.asm")
    ...
    def test_int_square_root(self):
        self.run_test_code("tests/Intel/int_square_root.asm")
        self.assertEqual(vmachine.registers["EAX"], 10)

    def test_add_to_array_elem_test(self):
        self.run_test_code("tests/Intel/change_array_elem_test.asm")
